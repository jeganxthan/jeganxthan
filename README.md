...
💻 I specialize in **web development** (React, Node.js) and backend technologies using **JS and Java**. I enjoy building **practical applications**, exploring new technologies, and sharing knowledge through code.  
...
![Tech Stack](https://skillicons.dev/icons?i=python,linux,docker,git,github,mongodb,vite,firebase,nodejs,nextjs,react,express,tailwind,ts,java,appwrite)
